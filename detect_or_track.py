...
def draw_boxes(img, bbox, identities=None, categories=None, confidences = None, names=None, colors = None):
    ...
    for i, box in enumerate(bbox):
        ...
        if not opt.nolabel:
            ...
            cv2.polylines(img, pts=[np.array([[1710,200], [1875,225], [1830, 845], [1485, 780]])], isClosed=True, color=(0, 255, 0), thickness=1, lineType=8)
    ...
    if csv_file:
        with open(csv_file, mode='w', newline='') as file:
            ...
            writer.writerow(["Frame", "Person ID"])
            for frame_id, person_id in enumerate(person_ids):
                writer.writerow([frame_id, person_id])
